...
class AkontaktiController extends Controller
{
    ...
    public function save()
    {
        ...
        DB::table('data_lang')
            ->where('lang', 'lv')->where('link','kontakti')
            ->update([
        ...
        DB::table('data_lang')
            ->where('lang', 'en')->where('link','contacts')
            ->update([
        ...
        DB::table('data_lang')
            ->where('lang', 'ru')->where('link','kontakty')
            ->update([
